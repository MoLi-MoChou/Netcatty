...
export const ruVaultMessages: Messages = {
  ...
  'hostDetails.os.title': 'Определение системы',
  'hostDetails.os.desc': 'Используйте автоматическое определение. Укажите систему вручную только при ошибке. Режим сетевого устройства настраивается отдельно.',
  'hostDetails.os.auto': 'Автоматически',
  'hostDetails.os.unknown': 'Другая / неизвестно',
  'hostDetails.os.selection': 'Выбор системы',
  'hostDetails.os.current': 'Текущая система',
