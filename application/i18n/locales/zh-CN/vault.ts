...
export const zhCNVaultMessages: Messages = {
  ...
  'hostDetails.os.title': '系统识别',
  'hostDetails.os.desc': '默认自动识别，仅在识别错误时手动指定。网络设备模式单独设置。',
  'hostDetails.os.auto': '自动识别',
  'hostDetails.os.unknown': '其他 / 未知',
  'hostDetails.os.selection': '识别方式',
  'hostDetails.os.current': '当前系统',
