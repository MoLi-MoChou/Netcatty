...
const GITHUB_API_URL = 'https://api.github.com/repos/MoLi-MoChou/Netcatty/releases/latest';
const RELEASES_PAGE_URL = 'https://github.com/MoLi-MoChou/Netcatty/releases';
